...
if (isset($_GET['id'])) {
    ...
    foreach($categoryArr as $cat) {
        if ($array['category'] === $cat['id']) {
            echo $category;
            $array['category'] = $cat['category_name'];
        }
    }
...
<body>
    ...
    <form action="" method="post">
        ...
        <input type="text" placeholder="Enter Product Name" id="name" name="name" value="<?= $array['name'] ?>">
        ...
        <select name="category" id="category">
            <?php
                foreach($categoryArr as $cat) {
            ?>
                <option value = <?= $cat['category_name'] ?> <?= $cat['category_name'] == $array['category'] ? 'selected' : '' ?>><?= $cat['category_name'] ?></option>
            <?php
                }
            ?>
        </select>
        ...
        <input type="Number" placeholder="Enter Product's Price" id="price" name="price" value="<?= $array['price'] ?>">
